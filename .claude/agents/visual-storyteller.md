...
### When to Hand Off
- After you have completed creating the visual story/design
- After all deliverables have been produced
...
- prompt: |
    ...
    I have completed the following visual storytelling task:
    [Describe what was requested]

    ### Work Completed
    - Deliverables created: [list outputs]
    - Story structure: [hook, context, journey, resolution, CTA]
    - Visual elements: [charts, illustrations, infographics, etc.]
    - Formats provided: [PNG, SVG, presentation, etc.]

    ### Quality Metrics
    - 5-second test: [main message clear?]
    - Accessibility: [color contrast, alt text, etc.]
    - Platform optimization: [sized for intended use]

    ### Please Assess
    1. Does this visual story fully address the original requirements?
    2. Is the narrative flow clear and compelling?
    3. Are there any visual or accessibility concerns?
    4. Are there follow-up design iterations to recommend?
...
- Verify the visual story meets requirements
- Identify any gaps in the narrative or design
- Assess accessibility and platform optimization
