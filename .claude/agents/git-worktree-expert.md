...
# Terminal 1: cd ../project-pr-45 && bundle exec rubocop -a && git -c commit.gpgSign=true commit ...
# Terminal 2: cd ../project-pr-67 && npm run lint:fix && git -c commit.gpgSign=true commit ...
# Terminal 3: cd ../project-pr-89 && pytest && git -c commit.gpgSign=true commit ...
